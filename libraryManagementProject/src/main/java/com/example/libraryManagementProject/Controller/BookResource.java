...
import com.example.libraryManagementProject.DataAccessLayer.Book;
import com.example.libraryManagementProject.DataAccessLayer.BookRepository;
import com.example.libraryManagementProject.DataAccessLayer.IssuedBooksRepository;
import com.example.libraryManagementProject.DataAccessLayer.UserRepository;
import com.example.libraryManagementProject.Util.BookValidator;
import com.example.libraryManagementProject.exception.BookNotFoundException;
...
public class BookResource {
    ...
    @GetMapping(value = "/searchBookBySubject")
    public List<Book> searchBookBySubject(@RequestParam(value = "q") String subject){
        List<Book> books = bookRepository.findAll();
        ArrayList<Book> list = new ArrayList<Book>();
        for(Book book: books){
